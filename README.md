...
<p align="left">
  🦄 <strong>Skills:</strong> TypeScript, NodeJS, ReactJS, GraphQL, TypeORM, NestJS, Docker, Styled-Components, DDD, Clean Arch, SOLID, XState, ApolloClient, Axios, Postgres, Mongo, Redis, React Native, Expo, NextJS, Redux, Jest, Git, Github Actions, AWS
</p>

<p align="left">
  💼 <strong>Tools:</strong> VS Code, Robo3t, DBeaver, Insomnia, ClickUp, Jira, Altair, Github, Linux, BitBucket
</p>
